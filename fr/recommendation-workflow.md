...
2. Données historiques collectées sur 14-30 jours (configurable)
...
Raison: CPU moyen 12%, Mémoire moyenne 28% sur 30 jours
...
3. **Vérification des Économies** (7-30 jours) :
...
- Économies Estimées : $2 847/mois
- Économies Réelles (30j) : $2 789/mois (98 % de l'estimation)
...
│ Période de Vérification : 30 jours              │
│                                                 │
│ Estimé :    $2 847/mois                         │
│ Réel :      $2 789/mois                         │
│ Précision : 98 %                                │
...
- Vérification des économies : 7-30 jours
...
- **Entrées** : Historique de métriques sur 30 jours par ressource
...
- **Sorties** : Prévisions à 30/60/90 jours avec intervalles de confiance
...
Jour 5-11 : Période de surveillance (7 jours)

Jour 12 : Vérification initiale des économies
          Ticket Jira mis à jour

Jour 30 : Vérification finale des économies
          Analyse de variance
          Ticket Jira fermé
```
...
2. **Surveiller Étroitement** : Observer les métriques pendant 7 jours post-implémentation
...
- Basées sur une moyenne glissante de 30 jours d'utilisation
...
**Formule** :
```
Économies Mensuelles = (Coût Actuel - Coût Recommandé) × 30 jours
