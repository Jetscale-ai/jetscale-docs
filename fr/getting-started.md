...
Jetscale est une plateforme SaaS qui découvre automatiquement les opportunités
d'économies de coûts dans votre infrastructure cloud. Ce guide vous accompagnera
dans la connexion de votre premier compte cloud et l'examen de vos premières
recommandations.
...
**Permissions :** Accès en lecture seule à EC2, RDS, EBS, ElastiCache, Cost
Explorer
...
4. Copiez l'ID de locataire, l'ID d'abonnement et les informations
   d'identification
...
**Permissions :** Accès en lecture seule aux Machines Virtuelles, SQL, Disques,
...
- Récupère l'historique de métriques d'utilisation depuis CloudWatch/Azure
  Monitor
...
- Utilisez les filtres pour trouver des types spécifiques (ex : "dimensionnement
  EC2")
...
- **Équilibré** : Afficher les recommandations à risque faible et moyen (par
  défaut)
...
- **Approbation automatique à faible risque** : Approuver automatiquement les
  recommandations < 100 $/mois
- **Règles personnalisées** : Définir les critères d'approbation (ex :
  "approuver automatiquement le dimensionnement EC2")
...
**Semaine 1 :** Approuver les recommandations à faible risque et économies
élevées :
...
- [Comment fonctionne Jetscale](how-it-works.md) - Plongée en profondeur dans la
  plateforme
